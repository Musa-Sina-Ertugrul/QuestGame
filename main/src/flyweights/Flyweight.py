...
class Animated(Flyweight):
    ...
    Flyweight.data["dark_spell_1"] = [
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)1.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)2.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)3.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)4.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)5.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)6.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)7.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)8.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)9.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)10.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)11.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)12.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)13.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)14.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)15.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)16.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 1/Separeted frames/Dark VFX 1 (40x32)17.png")
    ]
    Flyweight.data["dark_spell_2"] = [
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)1.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)2.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)3.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)4.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)5.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)6.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)7.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)8.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)9.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)10.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)11.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)12.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)13.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)14.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)15.png"),
        load(".assets/Dark VFX 01 - 02/Dark VFX 2/Separated Frames/Dark VFX 2 (48x64)16.png")
    ]
    ...
    Flyweight.data["ice_spell_start"] = [
    ...
    Flyweight.data["npc_ranger"] = [
        load(".assets/Lively_NPCs_v3.0/individual sprites/elementals/leaf_ranger/leaf_ranger_1.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/elementals/leaf_ranger/leaf_ranger_2.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/elementals/leaf_ranger/leaf_ranger_3.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/elementals/leaf_ranger/leaf_ranger_4.png")
    ]
    Flyweight.data["npc_gunslinger"] = [
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/gunslinger/gunslinger_1.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/gunslinger/gunslinger_2.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/gunslinger/gunslinger_3.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/gunslinger/gunslinger_4.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/gunslinger/gunslinger_5.png")
    ]
    ...
    Flyweight.data["npc_monk"] = [
        load(".assets/Lively_NPCs_v3.0/individual sprites/elementals/ground_monk/ground_monk_1.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/elementals/ground_monk/ground_monk_2.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/elementals/ground_monk/ground_monk_3.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/elementals/ground_monk/ground_monk_4.png")
    ]
    Flyweight.data["npc_trader"] = [
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/trader/trader_1.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/trader/trader_2.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/trader/trader_3.png"),
        load(".assets/Lively_NPCs_v3.0/individual sprites/steampunk/trader/trader_4.png")
    ]
