...
class Flyweight(ABC):
    ...
    data: Dict[str, List[Optional[Sound|Surface]]] = {}
...
class Animated(Flyweight):
    ...
    Flyweight.data["ice_spell_1_move"] = [
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable1.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable2.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable3.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable4.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable5.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable6.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable7.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable8.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable9.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 1/Separated Frames/VFX 1 Repeatable10.png"),
    ]
    ...
    Flyweight.data["ice_spell_2_active"] = [
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active1.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active2.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active3.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active4.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active5.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active6.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active7.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active8.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Active9.png"),
    ]
    Flyweight.data["ice_spell_2_ending"] = [
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending1.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending2.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending3.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending4.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending5.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending6.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending7.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending8.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending9.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending11.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending12.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending13.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending14.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending15.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending16.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending17.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Ending18.png"),
    ]
    Flyweight.data["ice_spell_2_start"] = [
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start1.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start2.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start3.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start4.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start5.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start6.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start7.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start8.png"),
        image.load(".assets/Ice Effect 01/Ice VFX 2/Separated Frames/Ice VFX 2 Start9.png"),
    ]
    ...
    Flyweight.data["npc_witch"] = [
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/witch/witch_00.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/witch/witch_01.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/witch/witch_02.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/witch/witch_03.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/witch/witch_04.png"),
    ]
    Flyweight.data["npc_king"] = [
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/king/king_00.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/king/king_01.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/king/king_02.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/king/king_03.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/king/king_04.png"),
    ]
    ...
    Flyweight.data["npc_fairy"] = [
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/fairy/fairy_1.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/fairy/fairy_2.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/fairy/fairy_3.png"),
        image.load(".assets/Lively_NPCs_v3.0/individual sprites/medieval/fairy/fairy_4.png"),
    ]
...
class NotAnimated(Flyweight):
    ...
    """
    Flyweight.data["crosshair"] = image.load(".assets\Crosshairs\Outline\CrosshairsOutline17.png")
    Flyweight.data["bg_mountain"] = image.load(".assets\Desolate Places\Cloudy Mountains.png")
    Flyweight.data["bg_moon"] = image.load(".assets\Desolate Places\Dusty Moon.png")
    Flyweight.data["bg_desert"] = image.load(".assets\Desolate Places\Hidden Desert.png")
