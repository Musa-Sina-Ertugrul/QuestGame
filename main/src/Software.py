...
from .Run import Run
from utils.utils import singelton # pylint: disable = import-error, no-name-in-module,wrong-import-order,wrong-import-position
...
class Software(Run):
    ...
    def __init__(self):
        ...
        self.__guis_ptr : Tuple[Tuple[object]] = self.__init_guis() # pylint: disable= W,E
    ...
    def __init_guis(self): # pylint: disable= W,E
        """sumary_line
